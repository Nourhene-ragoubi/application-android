...
public class Evenement extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getAllEvents();
        // Action lors de clique sur un event
        listE.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                final HashMap<String, Object> map = (HashMap<String, Object>) listE.getItemAtPosition(position);

                clubChoisit = map.get("IDE").toString();
                AlertDialog.Builder alert = new AlertDialog.Builder(Evenement.this);
                alert.setTitle("Evénement");
                alert.setIcon(R.drawable.c);
                alert.setMessage("Voulez vous participer à ce Evénement");
                alert.setPositiveButton("Oui", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        EspaceParent.montantAPayer = map.get("PP").toString();
                        Intent j = new Intent(Evenement.this, Paiement.class);
                        startActivity(j);
                        // insertAdhesionClub();
                    }
                });
    ...
    private void getAllEvents() {
        class PostAsync extends AsyncTask<String, String, String> {
            ...
            protected void onPreExecute() {
                pDialog = new ProgressDialog(Evenement.this);
            ...
            protected String doInBackground(String... arg0) {
                ...
                try {
                    ...
                    for (int i = 0; i < jArray.length(); i++) {
                        ...
                        mapp.put("IDE", json_data.getString("codeEvenement"));
            ...
            protected void onPostExecute(String result) {
                ...
                SimpleAdapter adapter1 = new SimpleAdapter(Evenement.this, eventsList,
