...
public class MesMessagesEns extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes_messages_ens);
        ...
        listMsg.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AlertDialog.Builder alert = new AlertDialog.Builder(MesMessagesEns.this);
    ...
    private void getAllMessage() {
        class PostAsync extends AsyncTask<String, String, String> {
            ...
            private String URL_PHP = SplashScreen.config+"msgEns.php";


            @Override
            protected void onPreExecute() {
                pDialog = new ProgressDialog(MesMessagesEns.this);
            ...
            protected String doInBackground(String... arg0) {
                ...
                try {
                    ...
                    for (int i = 0; i < jArray.length(); i++) {
                        ...
                        mapp.put("np", json_data.getString("nomParent")+" "+ json_data.getString("prenomParent"));
            ...
            protected void onPostExecute(String result) {
                ...
                SimpleAdapter adapter1 = new SimpleAdapter(MesMessagesEns.this, messagesList,
                        R.layout.item_message_ens, new String[]{"np","ss","dd"},
