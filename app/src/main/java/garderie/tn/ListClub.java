...
public class ListClub extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getAllClubs();
        // action lors de clique sur une club
        listC.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                final HashMap<String, Object> map = (HashMap<String, Object>) listC.getItemAtPosition(position);
                    ...
                    clubChoisit = map.get("IDC").toString();
                    AlertDialog.Builder alert = new AlertDialog.Builder(ListClub.this);
                    alert.setTitle("Adhésion");
                    alert.setIcon(R.drawable.c);
                    alert.setMessage("Voulez vous participer dans cette Club");
                    alert.setPositiveButton("Oui", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            EspaceParent.montantAPayer = map.get("ma").toString();
                            Intent j = new Intent(ListClub.this, Paiement.class);
                            startActivity(j);
                           // insertAdhesionClub();
                        }
                    });
                   ...
                   // Toast.makeText(ListClub.this, "Vous devez se connecter d'abord pour participer a cette club", Toast.LENGTH_SHORT).show();
    ...
    private void insertAdhesionClub()  {
        {
            class PostAsync extends AsyncTask<String, String, String> {
                JSONParser jsonParser = new JSONParser();
                private ProgressDialog pDialog;
                private  String url_php =    SplashScreen.config+"ParticiperClub.php";


                @Override
                protected void onPreExecute() {
                    pDialog = new ProgressDialog(ListClub.this);
                    pDialog.setMessage("Participation en cours...");
                ...
                protected String doInBackground(String... args) {
                    ...
                    try {
                        ...
                        params.add(new BasicNameValuePair("CC",clubChoisit ));
                ...
                protected void onPostExecute(String res) {
                    ...
                    if (res.contains("OK")) {
                        Toast.makeText(ListClub.this, "participation effectuée  avec succées", Toast.LENGTH_SHORT).show();
                        finish();
                    }else {
                        Toast.makeText(ListClub.this, "Erreur de participation", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void getAllClubs() {
        class PostAsync extends AsyncTask<String, String, String> {
            ...
            protected void onPostExecute(String result) {
                ...
                SimpleAdapter adapter1 = new SimpleAdapter(ListClub.this, clubsList,
                        R.layout.item_club, new String[]{"nn", "descrit", "ma"},
